function [BX_a,BY_a,BZ_a] = Field(BoucleCourant,I,X_Valeur,Y_Valeur,Z_Valeur)
    ...
    for y = 1:Y_NombreDeBoucle
        ...
        for z = 1:Z_NombreDeBoucle
            ...
            for w=1:NombreDeBoucle
                ...
                coord_z     = BoucleCourant(w).Coord(1,:);
                %coord_theta = BoucleCourant(w).Coord(2,:);
                coord_x = BoucleCourant(w).Coord(3,:);
                coord_y = BoucleCourant(w).Coord(4,:);
